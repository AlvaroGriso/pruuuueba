...
function cargaDatos() {
  ...
  xhttp.open("GET", "http://localhost/jaime/pruebasPHP/ejemplosBDAjax/servidor/verTodos.php", true);
  xhttp.send();
...
function envioAJAX() {
  ...
  xhttp.open("POST", "http://localhost/jaime/pruebasPHP/ejemplosBDAjax/servidor/insertarUNO.php", true);
